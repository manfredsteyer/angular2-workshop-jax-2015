...
var flug_suchen_1 = require('./flug-suchen/flug-suchen');
...
var service = [
    ...
    angular2_1.provide(registry_1.BASE_URL, { useValue: 'http://www.angular.at/api' }),
...
angular2_1.bootstrap(App, service);
